...
**As-of:** 2026-09-09  
**Use:** Copy a block into Grok. Doctrine: [READER.md](../READER.md).  
**Hard rules:** Never invent headlines or market facts. Cite only provided evidence. Unclear force → `DARK`. Tape wins vs headline psychology. Viral PnL DARK. Social heat ≠ size. No live orders. No auto-post. **No fake headlines.**
...
A later operator republish is planned around **2026-09-14**. Until then, this file on helix-community `main` is the pack.
...
- FREE RSS/cited URL only for ingest in this pack. Do not scrape paywalls.
