...
Architecture names live in [ARCHITECTURE.md](ARCHITECTURE.md). FLOW, Reader, and NOTE: [FLOW.md](FLOW.md), [READER.md](READER.md), [ALPHA-WRITER.md](ALPHA-WRITER.md), [ALPHA-FIVE-FORCES.md](ALPHA-FIVE-FORCES.md). Chart bot: [CHART-BOT.md](CHART-BOT.md), [TECHNICAL-ANALYSIS.md](TECHNICAL-ANALYSIS.md). Scout catalog: [SENSITIVE-INTEGRATIONS.md](SENSITIVE-INTEGRATIONS.md). Memory layers: [DATA-AND-MEMORY.md](DATA-AND-MEMORY.md). Use them even if you dislike the metaphors — the community needs a shared floor plan.
