...
- [TECHNICAL-ANALYSIS.md](docs/TECHNICAL-ANALYSIS.md) — TA specialist + Chart shots (no invented levels; no fake charts; no orders)
- [PATTERN-SETUPS.md](docs/PATTERN-SETUPS.md) — starter pattern lexicon (invalidation required; viral PnL DARK)
